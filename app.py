...
with tab0: 
    ...
    st.info("ACT est un projet exploratoire pour augmenter l'expert et le manager; L'objectif est de les aider à naviguer dans une forte incertitude systémique.")
